...
function updateXcodeProject(callback) {
  ...
  glob.sync(g).forEach(path => {
    ...
    project.parse(function (err) {
      ...
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqSdk.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqSdk.m", opt);
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapAvatar.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapAvatar.m", opt);
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCommon.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCommon.m", opt);
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCore.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCore.m", opt);
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapUser.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapUser.m", opt);
      project.addHeaderFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCognitoAuth.h", opt);
      project.addSourceFile(nodepath + "/react-native-my-fiziq-sdk/ios/RNMyFiziqWrapCognitoAuth.m", opt);
